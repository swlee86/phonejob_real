							...
							<tbody>
								<c:forEach var="list" items="${list}">
									<tr>
                       			 	...
                       			 	<a href="free_board_view.do?free_no=${list.free_no}&currentpage=${cpage}&pagesize=${pgsize}">${list.title}</a>
											&nbsp;&nbsp;&nbsp; 
					...
					<div class="btn-group">
						<c:if test="${cpage > 1}">
							<button type="button" class="btn btn-default"
								onclick="location.href='free_board_list.do?currentpage=${cpage-1}&pagesize=${pgsize}'">
							...
							<c:choose>
								...
								<c:otherwise>
									<button class="btn btn-default"
										onclick="location.href='free_board_list.do?currentpage=${i}&pagesize=${pgsize}'">${i}</button>
								</c:otherwise>
							</c:choose>
						</c:forEach>
