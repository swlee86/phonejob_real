		...
		<tr>
			...
			<c:choose>
				<c:when test="${username eq null}">
					<p style="float:right;"><a href=../common/login.do>로그인</a></p>
					<p style="float:right;" > | </p>
					<p style="float:right;" ><a href="../common/login.do">회원가입</a></p>
				</c:when>
				<c:otherwise>
					<p style="float:right;"><a href=../common/logout>&nbsp;&nbsp;로그아웃</a></p>
				</c:otherwise>
			</c:choose>
			<c:choose>
