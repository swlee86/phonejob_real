					...
					<div class="btn-group">
						<c:if test="${cpage > 1}">
							<button type="button" class="btn btn-default"
								onclick="location.href='../notice/noticeBoaradMain.do?currentpage=${cpage-1}&pagesize=${pgsize}'">
							...
							<c:choose>
								...
								<c:otherwise>
									<button class="btn btn-default"
										onclick="location.href='../notice/noticeBoaradMain.do?currentpage=${i}&pagesize=${pgsize}'">${i}</button>
								</c:otherwise>
							</c:choose>
						</c:forEach>
