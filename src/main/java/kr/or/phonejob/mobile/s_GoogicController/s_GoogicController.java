package kr.or.phonejob.mobile.s_GoogicController;
...
import kr.or.phonejob.pc.Service.PublicService;
...
@Controller
public class s_GoogicController {
	
	private static final Logger logger = LoggerFactory.getLogger(s_GoogicController.class);
	...
	//구직 등록 리스트 메뉴 이동
	@RequestMapping(value="/googic/s_googicMain.do", method=RequestMethod.GET)
	...
	//구직 등록창 오픈
	@RequestMapping(value="/googic/s_googicRegister.do", method=RequestMethod.GET)
	...
	@RequestMapping(value="/googic/s_googicRegister.do", method=RequestMethod.POST)
	...
	//상세 페이지 조회
	@RequestMapping(value="/googic/s_googicDetail.do", method=RequestMethod.GET)
	...
	@RequestMapping(value="/googic/s_googicModify.do", method=RequestMethod.POST)
	...
	//구직 정보 수정
	@RequestMapping(value="/googic/s_googicModifyOk.do", method=RequestMethod.POST)
