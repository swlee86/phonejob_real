...
import kr.or.phonejob.smart.s_Service.s_LogSaveService;
...
public class s_LoggerInterceptor extends HandlerInterceptorAdapter {
    private Logger logger = LoggerFactory.getLogger(this.getClass());

    @Autowired
    private s_LogSaveService lsservice;
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        ...
        s_LoginDto loginData = (s_LoginDto) session.getAttribute("loginData");
        ...
        s_LogSaveDto lsdto = new s_LogSaveDto();
