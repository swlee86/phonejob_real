package kr.or.phonejob.smart.s_LoginController;

import kr.or.phonejob.smart.s_Dao.s_LoginDao;
...
public class s_CustomAuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
   ...
   private Logger logger = LoggerFactory.getLogger(s_CustomAuthenticationSuccessHandler.class);
   ...
   public s_CustomAuthenticationSuccessHandler() {
      // TODO Auto-generated constructor stub
      targetUrlParameter = "";
      defaultUrl = "/s_Main.do";
      useReferer = false;
   }
   ...
   public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
	   ...
	   try{
		   s_LoginDao ldao = sqlsession.getMapper(s_LoginDao.class);
		   s_RegisterMemberDao rdao = sqlsession.getMapper(s_RegisterMemberDao.class);
		   s_MemberDetailDto pjudto = rdao.privateRegisterSelect(userid);
		   
		   s_LoginDto ldto = ldao.loginInfo1(userid);
		   logger.debug("Pj_members 데이터 : " + ldto.toString());

		   s_LoginDto ldto2 = ldao.loginInfo2(pjudto.getCredential_id());
		   ...
		   if(ldto.getGubun().equals("2")){
			   ...
			   s_LoginDto ldto3 = ldao.loginInfo3(pjudto.getCredential_id());
		   ...
		   response.sendRedirect("../s_Main.do");
	   }
