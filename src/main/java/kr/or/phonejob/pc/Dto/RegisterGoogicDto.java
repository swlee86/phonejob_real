...
public class RegisterGoogicDto {
	private String googic_no;
	private String pic;
	...
	public void setGoogic_no(String googic_no) {
		this.googic_no = googic_no;
	}
	...
	public void setTelhistory(String telhistory) {
		this.telhistory = telhistory;
	}
	...
	public String toString() {
		return "s_RegisterGoogicDto [googic_no=" + googic_no + ", pic=" + pic + ", userid=" + userid + ", username="
